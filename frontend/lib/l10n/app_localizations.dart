...
abstract class AppLocalizations {
  ...
  /// No description provided for @deactivateDialogTitle.
  ///
  /// In en, this message translates to:
  /// **'Deactivate Account?'**
  String get deactivateDialogTitle;

  /// No description provided for @deactivateDialogMessage.
  ///
  /// In en, this message translates to:
  /// **'Your profile will be hidden and you won\'t receive new job offers. You can reactivate anytime by logging back in.'**
  String get deactivateDialogMessage;
