...
class BookingService {
  static Future<http.Response> createBooking({
    ...
    const apiUrl = 'http://192.168.1.24:5000/api/bookings/create';
...
Future<Booking?> fetchNextJob() async {
  try {
    ...
    final url = 'http://192.168.1.24:5000/api/bookings/next-job';
...
Future<List<Map<String, dynamic>>> fetchTaskerBookings(String taskerId) async {
    final response = await http.get(Uri.parse('http://192.168.1.24:5000/api/bookings/$taskerId/summary'));
  ...
  const baseUrl = 'http://192.168.1.24:5000'; // ✅ Use your actual server IP
...
static Future<List<Map<String, dynamic>>> fetchUserBookings() async {
  try {
    ...
    final url = 'http://192.168.1.24:5000/api/bookings/userBookings';
  ...
  static Future<void> submitRating({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.1.24:5000/api/bookings/$bookingId/rate'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
